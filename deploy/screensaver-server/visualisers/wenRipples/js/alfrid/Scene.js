define(["glMatrix", "alfrid/GLTool", "alfrid/CameraPerspective", "alfrid/SceneRotation", "alfrid/Camera", "window"], function(glMatrix, GLTool, CameraPerspective, SceneRotation, Camera, window) {
